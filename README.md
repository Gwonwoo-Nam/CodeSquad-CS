...
### CompletableFuture
Promise와 비슷한 개념
Completable Future : 비동기 작업을 완료
supplyAsync : supplier를 구현, return 값 존재
runAsync : thread pool을 명시해줘야한다.
thenApply : function interface 구현, 앞의 리턴 값을 받아서 사용 가능
thenRun :
thenAccept : consumer를 구현, 파라미터 존재, 리턴 값 없음
